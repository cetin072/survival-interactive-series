...
export function assembleArchiveRun({ reader, graph = null, visual = null }) {
  ...
  if (!readerCurrent) demand(graph === null && visual === null, 'DOWNSTREAM_USED_STALE_READER')
  if (readerCurrent) {
  ...
  return {
    ...
    selected_point_ids: visual?.selection.selected_point_ids ?? [],
