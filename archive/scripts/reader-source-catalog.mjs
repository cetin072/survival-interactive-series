...
export const rawCatalog = {
  ...
  'C03-AFTERFALL': [...Array.from({ length: 10 }, (_, i) => ({ archivePath: `archive/content/transcripts/C03-AFTERFALL/S01/PART_C03_${pad(i + 1)}.md`, canonicalRef: `worldlines/AFTERFALL/seasons/S01/raw_transcript/PART_C03_${pad(i + 1)}.md`, group: 'S01', title: '두 거점의 기록' })), ...c03S02Parts],
}
