...
from survival_rpg.append_public_transcript_turn(
  ...
  encode(extensions.digest(convert_to('PLAYER exact turn pair test','UTF8'),'sha256'),'hex'),
  '00000000-0000-0000-0000-00000000b302',
  'GM exact turn pair test',
  encode(extensions.digest(convert_to('GM exact turn pair test','UTF8'),'sha256'),'hex'),
